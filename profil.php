...
<body>
      <main>
            <div class="profil">
                  <section class="profil__user">
                        <div class="profil__user-img">
                              <img src="#" alt="">
                        </div>
                        <div class="profil__user-info">
                              <p>Gauthier, 23 ans</p>
                        </div>
                  </section>
                        ...
                        <div class="profil__section-content">
                              <a href="profil/historique/historique.php" class="profil__item">
                                    ...
                                    <div class="profil__item-content">
                                          <h5>Historique de covoiturage</h5>
                                    </div>
                              ...
                              <a href="profil/attestation/attestation.php"class="profil__item">
                                    ...
                                    <div class="profil__item-content">
                                          <h5>Attestation de covoiturage</h5>
                                    </div>
                                    <div class="profil__item-cta">
                                          <img src="img/profil/cta/right-arrow.svg" alt="Flèche vers la droite">
                                    </div>
                              ...
                              <a href="/profil/vehicule/vehicule.php" class="profil__item">
                                    ...
                                    <div class="profil__item-content">
                                          <h5>Véhicule</h5>
                                          <p>Ajoutez-le pour faciliter la rencontre avec vos passagers</p>
                                    </div>
                                    <div class="profil__item-cta">
                                          <span>Ajouter</span>
                                    </div>
