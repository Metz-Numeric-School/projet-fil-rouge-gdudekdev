...
<body>
      ...
      <main>
            <div class="planning">
                  <section class="planning__friend">
                        <div class="planning__friend-content">
                  ...
                  <section class="planning__newride">
                        <div class="planning__newride-list">

                        </div>
                        <div class="planning__newride-content">
                              <h2>À la recherche de nouveaux covoitureurs?</h2>
