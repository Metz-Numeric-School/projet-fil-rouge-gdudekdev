...
<body>
      <div class="container">
            ...
            <?php
            // Exemple de tes tableaux
            $user_preferences = [
                  ['preferences_id' => 1, 'preferences_name' => 'Non-Smoking'],
            ];

            $all_preferences = [
                  ['preferences_id' => 1, 'preferences_name' => 'Non-Smoking'],
                  ['preferences_id' => 2, 'preferences_name' => 'Window Seat'],
                  ['preferences_id' => 3, 'preferences_name' => 'No Music'],
            ];

            // On crée un tableau d'IDs des préférences de l'utilisateur
            $user_preference_ids = array_column($user_preferences, 'preferences_id');
            ?>

            <div class="form-group">
                  <h5>Préférences</h5>
                  <?php foreach ($all_preferences as $pref): ?>
                        <div class="form-check">
                              <input
                                    class="form-check-input"
                                    type="checkbox"
                                    name="preferences[]"
                                    id="preference_<?= $pref['preferences_id'] ?>"
