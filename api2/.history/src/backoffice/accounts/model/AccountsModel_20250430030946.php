...
class AccountsModel
{
      ...
      public function handle($params)
      {
            ...
            if (isset($params['id'])) {
                  ...
                  $preferences = $this->fetchPreferences($params['id']);
                  $recordset = [
                        "accounts" => $recordset,
                        "roles" => $roles,
                        "divisions" => $divisions,
      ...
      private function fetchPreferences($id){
            return Database::getInstance()->getAllFromWhere('accounts_preferences',['stmt'=>"accounts_id =:id",'params'=>[':id'=>int($id)]]);
      }
}
