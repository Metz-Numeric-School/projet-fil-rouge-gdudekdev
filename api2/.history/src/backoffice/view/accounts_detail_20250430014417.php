            ...
            <div class="crud__main">
                  <div class="form__main">
                        <form method="post" action="index.php?page=process&table=<?= $table ?>&mode=save">
                              ...
                              <br>
                              <select name="divisions_id" id="role" class="form-control">
                                    <?php foreach ($divisions as $role): ?>
                                          <option value="<?= htmlspecialchars($role['divisions_id']) ?>" <?= ($role['divisions_id'] === $recordset['divisions_id']) ? 'selected' : '' ?>>
                                                <?= htmlspecialchars($role['divisions_name']) ?>
                                          </option>
                                    <?php endforeach; ?>
                              </select>
                              <br>
