            ...
            <div class="crud__main">
                  <table class="crud__table">
                        <tr>
                              ...
                              <?php foreach (Planifications::$array_accepted_key as $field):
                                    if ($field['crud_show']) { ?>
                              ...
                              <tr>
                                    <td class="crud__table-cell">
                                          <div class="crud__table-cta">
                                                <a href="index.php?page=planifications&id=<?= $planification->id() ?>"
                                                      class="crud__table-btn crud__table-btn--edit">Voir le détail</a>
                                                <a href="index.php?page=handlers&table=planifications&remove&id=<?= $planification->id() ?>"
