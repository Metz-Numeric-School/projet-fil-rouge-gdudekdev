      ...
      <div className="trajet__choice-item-main-container">
        <div className="trajet__choice-item-desc flex items-center gap-4">
          <div className="trajet__choice-item-desc-img">
            <img src="app/src/assets/img/chat/dummyChatProfil.png" alt={trajet.fullname} className="w-12 h-12 rounded-full" />
          </div>
          <div className="trajet__choice-item-desc-main">
            <div className="trajet__choice-item-desc-main-contact">
              <h4 className="text-lg font-semibold">{trajet.fullname}</h4>
              <p className="text-sm text-gray-600">{trajet.company}</p>
              <p className="text-xs text-gray-600">{trajet.division}</p>
              <h5 className="text-sm font-medium">RDV à {trajet.departure_time}</h5>
            </div>
            <div className="trajet__choice-item-desc-main-info flex items-center gap-2 text-gray-500">
              <IconLocation />
              <p>{trajet.departure}</p>
